...
// anything in front/behind these clipping planes will not be rendered
	...
	cCreateBox(mesh, 0.015, 0.015, 0.015, cVector3d(0, 0, 0), rot);
	...
	// WTF?? (don't push code that doesn't even compile pls...)
	//m_tool0->m_hapticPointThumb->m_sphereGoal->
